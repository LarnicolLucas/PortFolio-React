...
const animation = (element, in_out) => {
    ...
    const anim_params_in = {opacity: 1, x: 0, y: 0, duration: 1.5, ease: "elastic.out(1, 0.3)"};
    const anim_params_out = {opacity: 0, x: randomCo(700, -200), y: randomCo(500, 0) , duration: 1};
